			...
			<div class="content-grids" >
				...
				<div class="grid1" style="height: 223; width: 92%;margin-top:4;margin-left:3%">
					<div style="width: 66%; float: left">
						...
						<div class="clear"></div>
						<div class="box_m">
							<p><a href="javascript:void(0);" onclick="toNews('${news21.id}');">
							${news21.news_summary}</a></p>
						</div>
					</div>
			...
			<div class="content-grids">
				...
				<div class="specials">
					...
					<div id="movie" class="specials-grids" style="width:104%">
						...
						<c:forEach var="list_language" items="${list_language22}">
						<div class="special-grid spe-grid">
							<div class="myImg2" style="width: 406px; height: 208px;">
								<a href="javascript:void(0);" onclick="toNews('${list_language.id}');">
								${list_language.resource_location}</a></div>
							<a href="javascript:void(0);" onclick="toNews('${list_language.id}');">
							${list_language.resource_name}</a>
						</div>
						</c:forEach>
						<div class="clear"></div>
					</div>
					<div id="music" class="specials-grids" style="width:104%">
						...
						<div class="special-grid spe-grid">
							<div class="myImg2" style="width: 406px; height: 208px;">
								<a href="javascript:void(0);" onclick="toNews('${list_language.id}');">
								${list_language.resource_location}</a></div>
							<a href="javascript:void(0);" onclick="toNews('${list_language.id}');">${list_language.resource_name}</a>
						</div>
						</c:forEach>
						<div class="clear"></div>
					</div>
