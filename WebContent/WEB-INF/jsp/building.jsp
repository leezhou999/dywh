...
<body onload="toXian()">
	...
	<div class="header1">
		...
		<div class="top-nav1">
			...
			<a class="active1" href="toIndex">首页</a> <a class="active1"
				href="toLanguage">语言文化</a> <a
				style="background: #289cd8; color: #fff; margin-right: -4;"
				href="toBuilding">建筑文化</a> <a class="active1" href="toDiet">饮食文化</a>
	...
	<div style="width: 70%; height: 340px;" class="banner">
		<div class="box">
			<div class="list">
				<ul>
					<li class="p7"><a href="#">${list_building31.get(0).resource_location}</a>
					</li>
					<li class="p6"><a href="#">${list_building31.get(1).resource_location}</a>
					</li>
					<li class="p5"><a href="#">${list_building31.get(2).resource_location}</a>
					</li>
					<li class="p4"><a href="#">${list_building31.get(3).resource_location}</a>
					</li>
					<li class="p3"><a href="#">${list_building31.get(4).resource_location}</a>
					</li>
					<li class="p2"><a href="#">${list_building31.get(5).resource_location}</a>
					</li>
					<li class="p1"><a href="#">${list_building31.get(6).resource_location}</a>
					</li>
				</ul>
			</div>
			...
			<div class="content-grids">
				...
				<div class="specials">
					...
					<div id="city_xian" class="specials-grids" style="width:108%">
						...
						<c:forEach var="list_building" items="${list_building32}">
						<div class="special-grid spe-grid">
							<div class="myImg2" style="width: 406px; height: 208px;">
								<a href="javascript:void(0);" onclick="toNews('${list_building.id}');">
								${list_building.resource_location}</a></div>
							<a href="javascript:void(0);" onclick="toNews('${list_building.id}');">${list_building.resource_name}</a>
						</div>
						</c:forEach>
						<div class="clear"></div>
					</div>
					<div id="city_xianyang" class="specials-grids" style="width:108%">
						...
						<c:forEach var="list_building" items="${list_building33}">
						<div class="special-grid spe-grid">
							<div class="myImg2" style="width: 406px; height: 208px;">
								<a href="javascript:void(0);" onclick="toNews('${list_building.id}');">
								${list_building.resource_location}</a></div>
							<a href="javascript:void(0);" onclick="toNews('${list_building.id}');">
							${list_building.resource_name}</a>
						</div>
						</c:forEach>
						<div class="clear"></div>
					</div>
					<div id="city_weinan" class="specials-grids" style="width:108%">
						...
						<c:forEach var="list_building" items="${list_building34}">
						<div class="special-grid spe-grid">
							<div class="myImg2" style="width: 406px; height: 208px;">
								<a href="javascript:void(0);" onclick="toNews('${list_building.id}');">
								${list_building.resource_location}</a></div>
					...
					<div id="city_tongchuan" class="specials-grids" style="width:108%">
						...
						<c:forEach var="list_building" items="${list_building35}">
						<div class="special-grid spe-grid">
							<div class="myImg2" style="width: 406px; height: 208px;">
								<a href="javascript:void(0);" onclick="toNews('${list_building.id}');">
								${list_building.resource_location}</a></div>
					...
					<div id="city_baoji" class="specials-grids" style="width:108%">
						...
						<c:forEach var="list_building" items="${list_building36}">
						<div class="special-grid spe-grid">
							<div class="myImg2" style="width: 406px; height: 208px;">
								<a href="javascript:void(0);" onclick="toNews('${list_building.id}');">
								${list_building.resource_location}</a></div>
